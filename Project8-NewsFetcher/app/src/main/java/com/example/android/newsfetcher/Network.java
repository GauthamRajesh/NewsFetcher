...
public class Network {
    ...
    public static List<News> getNewsData(String dataUrl) {
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e(Network.class.getSimpleName(), "Problem building the URL ", e);
        }
        return url;
    }
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                News newsarticle = new News(title, section);
                news.add(newsarticle);
            }

        } catch (JSONException e) {
            Log.e("Network", "Problem parsing the earthquake JSON results", e);
        }
        return news;
    }
}
